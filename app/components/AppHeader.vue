      ...
      <nav class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
          ...
          <a
            ...
            :class="isDark
              ? 'border border-violet-500/40 text-violet-300 hover:border-violet-400 hover:bg-violet-500/10'
      ...
      <div v-if="mobileOpen"
        ...
        <UContainer>
          <ul class="py-4 flex flex-col gap-1">
            ...
            <li class="px-4 pt-2">
              <a href="mailto:laibanaseertts@gmail.com?subject=Hiring%20Inquiry%20from%20Portfolio&body=Hi%20Laiba%2C%0A%0AI%20came%20across%20your%20portfolio%20and%20I%27d%20love%20to%20discuss%20a%20potential%20opportunity.%0A%0A"
...
watch(isDark, (val) => {
  localStorage.setItem('colorMode', val ? 'dark' : 'light')
})
</script>
